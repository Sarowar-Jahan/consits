...
(function ($) {
  ...
  if (('.service-3-slider').length) {
    var service_3_slider = new Swiper(".service-3-slider", {
      ...
      watchSlidesProgress: true,
      navigation: {
        prevEl: ".service-3-button-prev",
        nextEl: ".service-3-button-next",
      },
      breakpoints: {
        // when window width is >= px
        576: {
  ...
  if (('.service-4-slider').length) {
    var service_4_slider = new Swiper(".service-4-slider", {
      ...
      watchSlidesProgress: true,
      navigation: {
        prevEl: ".service-4-button-prev",
        nextEl: ".service-4-button-next",
      },
      breakpoints: {
        // when window width is >= px
        576: {
  ...
  if (('.service-5-slider').length) {
    var service_5_slider = new Swiper(".service-5-slider", {
      ...
      watchSlidesProgress: true,
      navigation: {
        prevEl: ".service-5-button-prev",
        nextEl: ".service-5-button-next",
      },
      pagination: {
  ...
  if (('.project-3-slider').length) {
    var project_3_slider = new Swiper(".project-3-slider", {
      ...
      watchSlidesProgress: true,
      navigation: {
        prevEl: ".project-3-button-prev",
        nextEl: ".project-3-button-next",
      },
      breakpoints: {
        // when window width is >= px
        576: {
  ...
  if (document.querySelectorAll(".text-slider-5-active").length > 0) {
    var text_slider_5_active = new Swiper(".text-slider-5-active", {
      slidesPerView: 'auto',
      loop: true,
      autoplay: true,
      spaceBetween: 0,
  ...
  if (document.querySelectorAll(".text-slider-6-active").length > 0) {
    var text_slider_6_active = new Swiper(".text-slider-6-active", {
      slidesPerView: 'auto',
      loop: true,
      autoplay: true,
      spaceBetween: 0,
